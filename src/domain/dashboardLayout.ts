...
export const DASHBOARD_WIDGET_CATALOG: readonly DashboardWidgetDefinition[] = [
  ...
  { id: "overall-savings-rate", label: "Overall savings rate", section: "More intelligence", defaultOrder: 20, hideable: true },
  { id: "savings-investment-trend", label: "Savings & investment rate trend", section: "More intelligence", defaultOrder: 21, hideable: true },
  { id: "portfolio-growth-decomposition", label: "Portfolio growth decomposition", section: "More intelligence", defaultOrder: 22, hideable: true },
  { id: "contribution-vs-return", label: "Contribution vs return", section: "More intelligence", defaultOrder: 23, hideable: true },
  { id: "portfolio-performance", label: "Portfolio performance", section: "More intelligence", defaultOrder: 24, hideable: true },
  { id: "portfolio-vs-benchmark", label: "Portfolio vs benchmark", section: "More intelligence", defaultOrder: 25, hideable: true },
  { id: "goal-collision-detector", label: "Goal collision detector", section: "More intelligence", defaultOrder: 26, hideable: true },
  { id: "emergency-fund-runway", label: "Emergency fund runway", section: "More intelligence", defaultOrder: 27, hideable: true },
  { id: "goal-trade-off-simulator", label: "Goal trade-off simulator", section: "More intelligence", defaultOrder: 28, hideable: true },
  { id: "whats-changed", label: "What's changed", section: "More intelligence", defaultOrder: 29, hideable: true },
  { id: "financial-anomaly-detector", label: "Financial anomaly detector", section: "More intelligence", defaultOrder: 30, hideable: true },
  { id: "historical-coverage", label: "Historical coverage", section: "More intelligence", defaultOrder: 31, hideable: true },
  { id: "sip-increase-simulator", label: "SIP increase simulator", section: "Scenario engine", defaultOrder: 32, hideable: true },
  { id: "debt-prepayment-simulator", label: "Debt prepayment simulator", section: "Scenario engine", defaultOrder: 33, hideable: true },
  { id: "wealth-projection", label: "Wealth projection", section: "Scenario engine", defaultOrder: 34, hideable: true },
  { id: "financial-independence-projection", label: "Financial independence projection", section: "Scenario engine", defaultOrder: 35, hideable: true },
] as const;
